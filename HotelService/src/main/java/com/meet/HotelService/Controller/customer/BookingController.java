...
import com.meet.HotelService.services.customer.booking.BookingService;
...
public class BookingController {
    ...
    public ResponseEntity<?> getAllBooingsByUserId(@PathVariable Long userId,@PathVariable int pageNumber){
        try{
